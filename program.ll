...
@vtable_LinkedList = constant [5 x i8*] [i8* bitcast (%LinkedList_struct* (%LinkedList_struct*)* @LinkedList_init_list to i8*), i8* bitcast (%LinkedList_struct* (%LinkedList_struct*, %IntStruct*)* @LinkedList_insert to i8*), i8* bitcast (%LinkedList_struct* (%LinkedList_struct*, %IntStruct*)* @LinkedList_delete to i8*), i8* bitcast (%BoolStruct* (%LinkedList_struct*, %IntStruct*)* @LinkedList_search to i8*), i8* bitcast (%LinkedList_struct* (%LinkedList_struct*)* @LinkedList_print to i8*)]
@vtable_SetLL = constant [5 x i8*] [i8* bitcast (%SetLL_struct* (%SetLL_struct*)* @SetLL_init_set to i8*), i8* bitcast (%SetLL_struct* (%SetLL_struct*, %IntStruct*)* @SetLL_insert to i8*), i8* bitcast (%BoolStruct* (%SetLL_struct*, %IntStruct*)* @SetLL_contains to i8*), i8* bitcast (%SetLL_struct* (%SetLL_struct*, %IntStruct*)* @SetLL_delete to i8*), i8* bitcast (%SetLL_struct* (%SetLL_struct*)* @SetLL_print_set to i8*)]
...
@str_obj_9 = constant { i8* } { [37 x i8]* getelementptr inbounds ([37 x i8], [37 x i8]* @str_8) }
@str_10 = global [24 x i8] c"Deleting 2 from set...\0A\00"
@str_obj_11 = constant { i8* } { [24 x i8]* getelementptr inbounds ([24 x i8], [24 x i8]* @str_10) }
@str_12 = global [13 x i8] c"Contains 2? \00"
@str_obj_13 = constant { i8* } { [13 x i8]* getelementptr inbounds ([13 x i8], [13 x i8]* @str_12) }
...
define %LinkedList_struct* @LinkedList_delete(%LinkedList_struct* %self, %IntStruct* %val) {
entry:
	%0 = alloca %LinkedList_struct*
	store %LinkedList_struct* %self, %LinkedList_struct** %0
	%1 = load %LinkedList_struct*, %LinkedList_struct** %0
	...
	%18 = load i8*, i8** %17
	%19 = bitcast i8* %18 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%20 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %19, i32 0, i32 2
	%21 = load i8*, %ObjectStruct* (%ObjectStruct*)** %20
	%22 = bitcast i8* %21 to %Node_struct* (%Node_struct*)*
...
while_body_1:
	...
	%46 = load i8*, i8** %45
	%47 = bitcast i8* %46 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%48 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %47, i32 0, i32 0
	%49 = load i8*, %ObjectStruct* (%ObjectStruct*)** %48
	%50 = bitcast i8* %49 to %IntStruct* (%Node_struct*)*
...
if_then_3:
	...
	%71 = load i8*, i8** %70
	%72 = bitcast i8* %71 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%73 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %72, i32 0, i32 2
	%74 = load i8*, %ObjectStruct* (%ObjectStruct*)** %73
	%75 = bitcast i8* %74 to %Node_struct* (%Node_struct*)*
	...
	%79 = load i8*, i8** %78
	%80 = bitcast i8* %79 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%81 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %80, i32 0, i32 3
	%82 = load i8*, %ObjectStruct* (%ObjectStruct*)** %81
	%83 = bitcast i8* %82 to %Node_struct* (%Node_struct*, %Node_struct*)*
...
if_else_4:
	...
	%96 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %95, i32 0, i32 2
	%97 = load i8*, %ObjectStruct* (%ObjectStruct*)** %96
	%98 = bitcast i8* %97 to %Node_struct* (%Node_struct*)*
...
define %SetLL_struct* @SetLL_init_set(%SetLL_struct* %self) {
entry:
	%0 = alloca %SetLL_struct*
	store %SetLL_struct* %self, %SetLL_struct** %0
	%1 = load %SetLL_struct*, %SetLL_struct** %0
	%2 = bitcast %SetLL_struct* %1 to %SetLL_struct*
	...
	%8 = getelementptr %LinkedList_struct*, %SetLL_struct* %7, i32 1
	store %LinkedList_struct* %5, %LinkedList_struct** %8
	%9 = load %SetLL_struct*, %SetLL_struct** %3
	%10 = bitcast %SetLL_struct* %9 to %SetLL_struct*
	%11 = getelementptr %SetLL_struct, %SetLL_struct* %10, i32 0, i32 1
	...
	%16 = load i8*, i8** %15
	%17 = bitcast i8* %16 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%18 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %17, i32 0, i32 0
	%19 = load i8*, %ObjectStruct* (%ObjectStruct*)** %18
	%20 = bitcast i8* %19 to %LinkedList_struct* (%LinkedList_struct*)*
	%21 = call %LinkedList_struct* %20(%ObjectStruct* %13)
	%22 = load %SetLL_struct*, %SetLL_struct** %3
	ret %SetLL_struct* %22
}

define %SetLL_struct* @SetLL_insert(%SetLL_struct* %self, %IntStruct* %val) {
entry:
	%0 = alloca %SetLL_struct*
	store %SetLL_struct* %self, %SetLL_struct** %0
	%1 = load %SetLL_struct*, %SetLL_struct** %0
	...
	%13 = load i8*, i8** %12
	%14 = bitcast i8* %13 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%15 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %14, i32 0, i32 3
	%16 = load i8*, %ObjectStruct* (%ObjectStruct*)** %15
...
if_then_15:
	...
	%36 = load i8*, i8** %35
	%37 = bitcast i8* %36 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%38 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %37, i32 0, i32 1
...
define %BoolStruct* @SetLL_contains(%SetLL_struct* %self, %IntStruct* %val) {
entry:
	%0 = alloca %SetLL_struct*
	store %SetLL_struct* %self, %SetLL_struct** %0
	%1 = load %SetLL_struct*, %SetLL_struct** %0
...
define %SetLL_struct* @SetLL_delete(%SetLL_struct* %self, %IntStruct* %val) {
entry:
	%0 = alloca %SetLL_struct*
	store %SetLL_struct* %self, %SetLL_struct** %0
	%1 = load %SetLL_struct*, %SetLL_struct** %0
	...
	%15 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %14, i32 0, i32 2
	%16 = load i8*, %ObjectStruct* (%ObjectStruct*)** %15
	%17 = bitcast i8* %16 to %LinkedList_struct* (%LinkedList_struct*, %IntStruct*)*
	%18 = call %LinkedList_struct* %17(%ObjectStruct* %9, %IntStruct* %10)
	%19 = load %SetLL_struct*, %SetLL_struct** %3
	ret %SetLL_struct* %19
}

define %SetLL_struct* @SetLL_print_set(%SetLL_struct* %self) {
entry:
	%0 = alloca %SetLL_struct*
	store %SetLL_struct* %self, %SetLL_struct** %0
	%1 = load %SetLL_struct*, %SetLL_struct** %0
	...
	%11 = load i8*, i8** %10
	%12 = bitcast i8* %11 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%13 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %12, i32 0, i32 4
...
entry:
	...
	%15 = load i8*, %ObjectStruct* (%ObjectStruct*)** %14
	%16 = bitcast i8* %15 to %SetLL_struct* (%SetLL_struct*)*
	...
	%27 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %26, i32 0, i32 1
	%28 = load i8*, %ObjectStruct* (%ObjectStruct*)** %27
	%29 = bitcast i8* %28 to %SetLL_struct* (%SetLL_struct*, %IntStruct*)*
	...
	%40 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %39, i32 0, i32 1
	%41 = load i8*, %ObjectStruct* (%ObjectStruct*)** %40
	%42 = bitcast i8* %41 to %SetLL_struct* (%SetLL_struct*, %IntStruct*)*
	...
	%51 = load i8*, i8** %50
	%52 = bitcast i8* %51 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%53 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %52, i32 0, i32 1
	%54 = load i8*, %ObjectStruct* (%ObjectStruct*)** %53
	%55 = bitcast i8* %54 to %SetLL_struct* (%SetLL_struct*, %IntStruct*)*
	...
	%64 = load i8*, i8** %63
	%65 = bitcast i8* %64 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%66 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %65, i32 0, i32 1
	%67 = load i8*, %ObjectStruct* (%ObjectStruct*)** %66
	%68 = bitcast i8* %67 to %SetLL_struct* (%SetLL_struct*, %IntStruct*)*
	...
	%79 = load i8*, i8** %78
	%80 = bitcast i8* %79 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%81 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %80, i32 0, i32 4
	%82 = load i8*, %ObjectStruct* (%ObjectStruct*)** %81
	%83 = bitcast i8* %82 to %SetLL_struct* (%SetLL_struct*)*
	...
	%97 = load i8*, i8** %96
	%98 = bitcast i8* %97 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%99 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %98, i32 0, i32 3
	%100 = load i8*, %ObjectStruct* (%ObjectStruct*)** %99
	%101 = bitcast i8* %100 to %SetLL_struct* (%SetLL_struct*, %IntStruct*)*
	...
	%107 = load i8*, i8** %106
	%108 = bitcast i8* %107 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%109 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %108, i32 0, i32 4
	%110 = load i8*, %ObjectStruct* (%ObjectStruct*)** %109
	%111 = bitcast i8* %110 to %SetLL_struct* (%SetLL_struct*)*
	...
	%125 = load i8*, i8** %124
	%126 = bitcast i8* %125 to [5 x %ObjectStruct* (%ObjectStruct*)*]*
	%127 = getelementptr [5 x %ObjectStruct* (%ObjectStruct*)*], [5 x %ObjectStruct* (%ObjectStruct*)*]* %126, i32 0, i32 2
	%128 = load i8*, %ObjectStruct* (%ObjectStruct*)** %127
	%129 = bitcast i8* %128 to %BoolStruct* (%SetLL_struct*, %IntStruct*)*
