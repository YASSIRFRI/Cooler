...
while_cond_0:
	...
	br i1 %24, label %while_body_1, label %while_end_2
...
while_cond_3:
	...
	br i1 %52, label %while_body_4, label %while_end_5

while_body_4:
	%53 = getelementptr %StringStruct, %StringStruct* bitcast ({ i8* }* @str_obj_5 to %StringStruct*), i32 0, i32 0
	%54 = load i8*, i8** %53
...
while_cond_6:
	...
	br i1 %108, label %while_body_7, label %while_end_8

while_body_7:
	%109 = getelementptr %StringStruct, %StringStruct* bitcast ({ i8* }* @str_obj_7 to %StringStruct*), i32 0, i32 0
	%110 = load i8*, i8** %109
...
while_end_8:
	%126 = getelementptr %StringStruct, %StringStruct* bitcast ({ i8* }* @str_obj_9 to %StringStruct*), i32 0, i32 0
	%127 = load i8*, i8** %126
