...
func CodegenProgram(prog *parser.Program) *ir.Module {
	...
	// TODO: Maybe you can use primitive int type in LLVM
	...
	// TODO: Same as int there should be an i1 type in llvm you can use
...
func findFuncByName(mod *ir.Module, name string) *ir.Func {
	// TODO: What happens if you are trying to import an LLVM function that does not exist.
	// Maybe you can at least add a warning or error?
